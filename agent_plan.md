...
| ID        | Phase   | Sprint       | Story                                                 | Status      | Owner      | Branch/PR                                    | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| --------- | ------- | ------------ | ----------------------------------------------------- | ----------- | ---------- | -------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| NADAA-150 | Phase 3 | Sprint 13/14 | Real-Time Flood Simulation                            | Done        | Kimi       | feature/NADAA-150-real-time-flood-simulation | Extended services/ml-service with POST/GET /api/v1/ml/flood/simulations, deterministic logistic scoring over NADAA-070 feature grid, scenario overrides, GeoJSON frames, assumptions/limitations, and safety policy. Added authority-dashboard FloodSimulationPanel with scenario form, frame slider, severity summary, and Leaflet overlay. Shared TypeScript contracts, smoke script, docs, dashboard record, CI/Docker wiring. Full workspace verification passed. |
| NADAA-151 | Phase 3 | Sprint 13    | AI Incident Triage                                    | In Progress | Kimi       | feature/NADAA-151-ai-incident-triage         | Claimed. First-pass triage suggestions for severity, duplicate likelihood, affected population, and suggested agency routing with dispatcher UI and override logging. Implementation plan required before coding.                                                                                                                                                                                                                                                     |
| NADAA-152 | Phase 3 | Sprint 14    | Computer Vision For Flood And Fire Image Verification | Done        | Kimi       | feature/NADAA-152-cv-image-verification    | Extended ml-service with POST/GET /api/v1/cv/* endpoints, deterministic rule-based mock engine, CVEvidencePanel in authority-dashboard, shared TypeScript contracts, smoke script, docs, dashboard record. Full workspace verification passed. Safety: decision-support only, humanReviewRequired for low confidence or sensitive labels. |
