...
| NADAA-140 | Phase 2 Sprint 12              | Drone And Satellite Image Ingestion                         | Done   | Kimi  | feature/NADAA-140-drone-satellite-image-ingestion | NADAA-031, NADAA-040, NADAA-070                       | 2026-07-07  | Imagery-service Go API completed with multipart drone/satellite/other image upload, metadata validation, local disk file storage, authority list/detail/download/delete/expire endpoints, retention lifecycle runner, public GeoJSON footprint FeatureCollection, structured INFO/WARN/ERROR logging, tests, Dockerfile, README, dashboard record, CI matrix entries, and verification. |
