...
func (s *server) Routes() http.Handler {
	...
	mux.HandleFunc("DELETE /api/v1/shelters/{id}", s.deleteShelterHandler)
	...
	mux.HandleFunc("DELETE /api/v1/relief-points/{id}", s.deleteReliefPointHandler)
	...
	mux.HandleFunc("DELETE /api/v1/aid-requests/{id}", s.deleteAidRequestHandler)
