...
func (s *Server) Routes() http.Handler {
	...
	mux.HandleFunc("POST /api/v1/notifications/cell-broadcasts", s.createCellBroadcastHandler)
	mux.HandleFunc("GET /api/v1/notifications/cell-broadcasts", s.listCellBroadcastHandler)
	mux.HandleFunc("GET /api/v1/notifications/cell-broadcasts/{id}/preview", s.previewCellBroadcastHandler)
	mux.HandleFunc("POST /api/v1/notifications/cell-broadcasts/{id}/review", s.reviewCellBroadcastHandler)
	mux.HandleFunc("POST /api/v1/notifications/cell-broadcasts/{id}/deliver", s.deliverCellBroadcastHandler)
