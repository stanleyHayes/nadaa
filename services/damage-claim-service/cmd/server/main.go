...
import (
	...
	"github.com/stanleyHayes/nadaa/services/damage-claim-service/internal/handlers"
	"github.com/stanleyHayes/nadaa/services/damage-claim-service/internal/store"
)

const serviceName = "damage-claim-service"
...
func main() {
	...
	go func() {
		log.Printf("INFO %s listening on %s", serviceName, cfg.Addr)
