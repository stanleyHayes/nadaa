...
func TestCreateSubmitAndApproveAlert(t *testing.T) {
	...
	var submitted models.AuthorityAlert
	...
	var approved models.AuthorityAlert
...
func TestCreateAlertStoresSourcePredictionInAudit(t *testing.T) {
	...
	afterPrediction, ok := logs[0].After["sourcePrediction"].(*models.AlertSourcePrediction)
...
func TestRejectRequiresReasonAndAudits(t *testing.T) {
	...
	var rejected models.AuthorityAlert
...
func TestPreviewDistrictTargetReturnsGeometry(t *testing.T) {
	...
	var payload models.TargetPreviewResponse
	decodeResponse(t, response, &payload)
...
func createAndSubmitAlert(t *testing.T, srv *Server) models.AuthorityAlert {
	t.Helper()
	draft := createAlert(t, srv)
...
func createAlert(t *testing.T, srv *Server) models.AuthorityAlert {
	t.Helper()
	return createAlertWithBody(t, srv, validAlertBody())
}

func createAlertWithBody(t *testing.T, srv *Server, body string) models.AuthorityAlert {
	t.Helper()
	response := httptest.NewRecorder()
	...
	var alert models.AuthorityAlert
