...
With the incident service running on `:8084`, verify the status workflow with `pnpm smoke:incident-workflow` and agency assignment with `pnpm smoke:incident-assignment`.
