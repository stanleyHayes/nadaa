...
| `ml-service`           | Flood-risk prediction, simulation, CV verification, and resource-demand forecasting from versioned model artifacts.               | `POST /api/v1/ml/flood/predictions`, `GET /api/v1/ml/prediction-logs`, `GET /api/v1/forecasts`, `GET /api/v1/staging-suggestions`, `POST /api/v1/forecasts/compare` |
