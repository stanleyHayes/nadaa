...
- Current alerts.
- Area risk search.
- Incident reporting with GPS and photo/media metadata.
- Emergency contacts.
- Offline emergency guides.
- Basic shelter map/list.
...
- Targeted alert by region/district/radius.
- Agency assignment.
- Incident timeline.
...
- Human review before alert publication.
...
- Telecom cell broadcast integration.
