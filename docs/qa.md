...
| Missing persons module        | NADAA-132                                  | API, E2E, Audit       | Private intake, authority review/public approval, public search privacy, closure/reunification audit | Phase 2 API smoke, Go tests, citizen/authority web typechecks covered                                                 |
