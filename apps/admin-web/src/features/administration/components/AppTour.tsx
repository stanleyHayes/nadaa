...
const COMPLETE_KEY = "nadaa.admin.tour-complete";
...
const STEPS: TourStep[] = [
  {
    ...
    title: "Governance sections",
    description:
      "Move between every console area here — Overview, the agency and user directory, the access and policy desks, and the governance trail. Collapse the rail when you need more room.",
  },
  {
    selector: "[data-tour='page-header']",
    title: "Where you are",
    description:
      "The header names the current console area and sums up what it governs, so you always know which desk you are working.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Switch the console between light and dark mode. Your choice is saved on this browser.",
  },
  {
    selector: "[data-tour='topbar-notifications']",
    title: "Governance notices",
    description:
      "Users awaiting MFA, alert rules still in review, and unreachable governance APIs surface here as you work.",
  },
  {
