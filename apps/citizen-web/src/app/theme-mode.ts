/**
 * Reactive appearance store for the citizen PWA.
 *
 * Wraps the shared `@nadaa/brand` theme-preference helpers in a tiny external
 * store so the MUI theme can rebuild when the citizen flips light/dark. The
...
/** The tint applied at boot (Ink unless the citizen saved another). */
