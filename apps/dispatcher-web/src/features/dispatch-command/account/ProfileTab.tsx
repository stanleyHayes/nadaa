    ...
    >
      ...
      <Stack spacing={2.5}>
        <SettingCard
          icon={ShieldCheck}
          title={user.name}
          description={roleLabels[user.role]}
        >
          <Stack spacing={1.5}>
          ...
          >
            Access is assigned from your role. Contact an administrator to change
            your agency or district.
          </Typography>
        </SettingCard>
      </Stack>
      <Snackbar
