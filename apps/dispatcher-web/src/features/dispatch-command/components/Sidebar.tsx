...
type SidebarProps = {
  /**
   * The active section; "settings" and "guide" leave every rail item
   * unhighlighted.
   */
...
const GROUPS_KEY = "nadaa.dispatch.nav.groups";
      ...
      <div className="cc-rail__brand">
        ...
        {!compact ? (
          <div className="cc-rail__brand-text">
            ...
            <span className="cc-rail__brand-sub">Dispatch</span>
          </div>
        ) : null}
      </div>

      <nav className="cc-nav" aria-label="Dispatch console sections">
        {compact
          ? navGroups.map((group) => (
      ...
      <div className="cc-rail__foot">
        {!compact ? (
          <div className="cc-rail__status">
            ...
            <span>Greater Accra · dispatch desk</span>
          </div>
        ) : null}
