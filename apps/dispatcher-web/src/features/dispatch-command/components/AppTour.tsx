...
const COMPLETE_KEY = "nadaa.dispatcher.tour-complete";
...
const STEPS: TourStep[] = [
  {
    ...
    title: "Dispatch sections",
    description:
      "Move between every desk here — Overview, the incident queue, alerts and broadcast, AI triage, ML flood review, and capacity and relief. Collapse the rail when you need more room for the map.",
  },
  {
    selector: "[data-tour='page-header']",
    title: "Where you are",
    description:
      "The header names the current desk and sums up what it is for, so you always know which part of the dispatch console you are working.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Switch the dispatch console between light and dark mode. Your choice is saved on this browser.",
  },
  {
    selector: "[data-tour='topbar-notifications']",
    title: "Operational notices",
    description:
      "High-severity incidents, alerts awaiting approval, and ML flood signals needing review surface here as you work.",
  },
  {
...
export function AppTour() {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-label="Dispatch console tour"
    >
