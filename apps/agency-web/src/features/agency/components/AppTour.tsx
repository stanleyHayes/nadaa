...
const COMPLETE_KEY = "nadaa.agency.tour-complete";
...
const STEPS: TourStep[] = [
  {
    ...
    title: "Agency sections",
    description:
      "Move between every workspace here — Overview, Assigned incidents, Nearby capacity, Relief distribution, and Aid. Collapse the rail when you need more room.",
  },
  {
    selector: "[data-tour='page-header']",
    title: "Where you are",
    description:
      "The header names your current desk and sums up what it is for, so you always know which workspace you are in.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Switch the field desk between light and dark mode. Your choice is saved on this browser.",
  },
  {
    selector: "[data-tour='topbar-notifications']",
    title: "Operational notices",
    description:
      "Priority incidents, assignments awaiting response, aid needs, and shelters near capacity surface here as you work.",
  },
  {
...
export function AppTour() {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-label="Agency dashboard tour"
    >
